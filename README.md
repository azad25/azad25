...
- **[Finantial AI Assistant:]([https://github.com/azad25/RAG-QA-CHAT](https://github.com/azad25/moneymind-finance-ai-agent))** AI-powered financial assistant designed to handle accounts,balance,expenses, budgets, subscriptions, currency conversions, and real-time financial intelligence through natural language.
